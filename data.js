...
const TEAMS = [
  { owner:'Charles',   team:'Chuckys Cutlets',         company:'Crownline Global Holdings',   ticker:'CROWN', history:[{d:'Dec 2025',p:118.28},{d:'May 2026',p:139.84},{d:'Jul 2026',p:135.34},{d:'Jul 17 2026',p:139.28}], trend:'Pick and TE gains push price back within reach of the May peak',        qb:100,rb:92, wr:60, te:92, pick:60, strength:'QB',     weakness:'Pick Liquidity', summary:'Elite operating platform with premium QB/RB/TE strength' },
  { owner:'Corbishley',team:'Guiness Guzzlers',         company:'Apex Iron Capital',           ticker:'APEX',  history:[{d:'Dec 2025',p:87.53},{d:'May 2026',p:107.27},{d:'Jul 2026',p:114.53},{d:'Jul 17 2026',p:111.66}], trend:'QB rank slips to 9th in the reshuffle; contender core intact',     qb:36,rb:76, wr:84, te:76, pick:20, strength:'RB/WR',  weakness:'QB',            summary:'Explosive skill-position portfolio dragged by QB concerns' },
  { owner:'Shaq',      team:'The Shough Boys',          company:'Monarch Wideout Bank',        ticker:'MWB',   history:[{d:'Dec 2025',p:87.73},{d:'May 2026',p:100.98},{d:'Jul 2026',p:109.39},{d:'Jul 17 2026',p:109.39}], trend:'Sat out the trade cycle; WR bank untouched',              qb:76,rb:28, wr:100, te:68, pick:68, strength:'WR',     weakness:'RB',            summary:'Luxury WR bank with underfunded RB cash flow' },
  { owner:'Adam',      team:'The 100xers',              company:'Helix Quant Strategies',      ticker:'HLX',   history:[{d:'Dec 2025',p:68.37},{d:'May 2026',p:92.23},{d:'Jul 2026',p:92.58},{d:'Jul 17 2026',p:86.21}],  trend:'Bought starters, emptied the vault; pick portfolio now dead last',qb:68,rb:36, wr:92, te:60, pick:12, strength:'WR',     weakness:'RB',            summary:'Strong WR/young asset base with weak current RB output' },
  { owner:'Jake',      team:'yakeyaine',                company:'EchoPoint Global Markets',    ticker:'ECHO',  history:[{d:'Dec 2025',p:86.28},{d:'May 2026',p:99.58},{d:'Jul 2026',p:105.22},{d:'Jul 17 2026',p:105.22}],  trend:'Held position through the trade cycle; RB engine humming',                qb:60,rb:100, wr:52, te:28, pick:92, strength:'RB',     weakness:'TE',            summary:'Liquidity-heavy trading desk powered by elite RB and solid QB' },
  { owner:'Fronge',    team:'JD Power & Ass.',          company:'ForgeHammer Industries',      ticker:'FORG',  history:[{d:'Dec 2025',p:97.43},{d:'May 2026',p:94.03},{d:'Jul 2026',p:84.6},{d:'Jul 17 2026',p:81.54}],  trend:'Shipped QB value for pick liquidity; correction deepens',             qb:52,rb:84, wr:28, te:36, pick:28, strength:'RB/QB',  weakness:'Pick Liquidity', summary:'High-impact factory contender with thin support and no reserves' },
  { owner:'Brent',     team:'2028 League Champs',       company:'Obsidian Specialty Holdings', ticker:'OBS',   history:[{d:'Dec 2025',p:75.4},{d:'May 2026',p:87.62},{d:'Jul 2026',p:79.05},{d:'Jul 17 2026',p:79.05}],  trend:'No movement; TE monopoly still carrying the balance sheet',          qb:20,rb:12, wr:68, te:100, pick:84, strength:'TE',     weakness:'QB/RB',         summary:'Elite TE and future assets attached to broken operations' },
  { owner:'Wingard',   team:'Mile High Bo',             company:'Sovereign Draft Reserve',     ticker:'SDR',   history:[{d:'Dec 2025',p:81.02},{d:'May 2026',p:74.63},{d:'Jul 2026',p:73.37},{d:'Jul 17 2026',p:73.37}],  trend:'Vault untouched; still the future-capital superpower',  qb:28,rb:60, wr:44, te:44, pick:100,strength:'Pick Portfolio',weakness:'QB', summary:'Offshore futures empire with current production discount' },
  { owner:'Mitchum',   team:'Mitchumm11',               company:'Deepwater Supply Co.',        ticker:'DEEP',  history:[{d:'Dec 2025',p:100.66},{d:'May 2026',p:85.2},{d:'Jul 2026',p:68.7},{d:'Jul 17 2026',p:72.36}],  trend:'Climbs RB and pick rungs in the reshuffle; slide arrested',      qb:12,rb:44, wr:76, te:52, pick:52, strength:'WR',     weakness:'QB',            summary:'Deep WR warehouse with unclear consolidation strategy' },
  { owner:'Ryan',      team:'Diggs-y Party',            company:'Aegis Quarterback Systems',   ticker:'AEGIS', history:[{d:'Dec 2025',p:76.63},{d:'May 2026',p:77.61},{d:'Jul 2026',p:118.42},{d:'Jul 17 2026',p:115.54}],  trend:'Champion premium intact; TE rank dips to 3rd',    qb:92,rb:68, wr:12, te:84, pick:76, strength:'QB',     weakness:'WR',            summary:'Defending champion with elite command systems but broken WR supply chain' },
  { owner:'Kevin',     team:'ksanda',                   company:'Redline Distressed Capital',  ticker:'RDC',   history:[{d:'Dec 2025',p:126.29},{d:'May 2026',p:69.47},{d:'Jul 2026',p:64.48},{d:'Jul 17 2026',p:68.30}],  trend:'Turnaround gains real ground as the market reshuffles below',           qb:84,rb:52, wr:20, te:12, pick:44, strength:'QB',     weakness:'TE',            summary:'Premium QB leverage trapped in distressed supporting structure' },
  { owner:'Drew',      team:'Brazzellian Booty Lift',   company:'Atlas Rebuild Works',         ticker:'ATLAS', history:[{d:'Dec 2025',p:106.18},{d:'May 2026',p:47.52},{d:'Jul 2026',p:44.38},{d:'Jul 17 2026',p:48.09}],  trend:'Rebuild reprices upward; still the cheapest listing',       qb:44,rb:20, wr:36, te:20, pick:36, strength:'QB',     weakness:'RB',            summary:'Recognizable assets inside an unfinished rebuild' },
];
...
const MOVEMENT = {
  Charles:   { stockRank:{now:1, prev:1},  power:{now:1, prev:1},   proj:{now:1, prev:1},   playoff:{now:92, prev:89}, conf:{now:91, prev:84}, asset:{now:1, prev:1},   hq:'Manhattan, NY',    risk:{level:'Low',    text:'Championship-or-bust: any finish short of a title triggers a board reckoning.'}, headline:'Crownline climbs to $139.28 without making a call — one point shy of its all-time high.' },
  ...
  Adam:      { stockRank:{now:6, prev:8},  power:{now:7, prev:10},  proj:{now:7, prev:9},   playoff:{now:47, prev:31}, conf:{now:79, prev:68}, asset:{now:5, prev:6},   hq:'Chicago, IL',      risk:{level:'Medium', text:'Model-driven turnaround still unproven against live competition.'}, headline:'Helix buys the starters and sells the future — the vault is empty and the market noticed.' },
  ...
  Ryan:      { stockRank:{now:9, prev:9},  power:{now:6, prev:6},   proj:{now:5, prev:6},   playoff:{now:62, prev:58}, conf:{now:71, prev:70}, asset:{now:9, prev:10},  hq:'Philadelphia, PA', risk:{level:'Medium', text:'Repeat skepticism is priced in; the WR supply chain is still broken.'}, headline:'Aegis holds near its post-title high — the champion premium is no longer up for debate.' },
  Kevin:     { stockRank:{now:11, prev:10},power:{now:11, prev:11}, proj:{now:9, prev:9},   playoff:{now:31, prev:28}, conf:{now:33, prev:26}, asset:{now:11, prev:11}, hq:'Detroit, MI',      risk:{level:'Severe', text:'Post-scandal trust deficit; one more misstep invites a hostile takeover.'}, headline:'Redline climbs to $68.30 — the recovery narrative finally has legs.' },
  Drew:      { stockRank:{now:12, prev:11},power:{now:12, prev:12}, proj:{now:12, prev:12}, playoff:{now:6, prev:11},  conf:{now:28, prev:41}, asset:{now:12, prev:12}, hq:'Sao Paulo, BR',    risk:{level:'Severe', text:'Liquidation risk: aging assets depreciating faster than the rebuild absorbs.'}, headline:'Atlas reprices to $48.09 — still the cheapest listing on the exchange.' },
};

// Previous positional RANKS (1-12, lower = better) — current ranks are computed live from TEAMS
const PREV_POS_RANKS = {
  Charles:   { qb:1,   rb:2,   wr:6,   te:3,   pick:7  },
  Corbishley:{ qb:8,   rb:4,   wr:3,   te:4,   pick:11 },
  Shaq:      { qb:4,   rb:10,  wr:1,   te:5,   pick:5  },
  Adam:      { qb:7,   rb:7,   wr:2,   te:6,   pick:6  },
  Jake:      { qb:6,   rb:1,   wr:7,   te:10,  pick:2  },
  Fronge:    { qb:5,   rb:3,   wr:10,  te:9,   pick:12 },
  Brent:     { qb:11,  rb:12,  wr:5,   te:1,   pick:3  },
  Wingard:   { qb:10,  rb:6,   wr:8,   te:8,   pick:1  },
  Mitchum:   { qb:12,  rb:9,   wr:4,   te:7,   pick:8  },
  Ryan:      { qb:2,   rb:5,   wr:12,  te:2,   pick:4  },
  Kevin:     { qb:3,   rb:8,   wr:11,  te:12,  pick:9  },
  Drew:      { qb:9,   rb:11,  wr:9,   te:11,  pick:10 },
};
...
const TIMELINE = [
  ...
  { date:'Jul 2026', tag:'TRADE',        color:'red',    title:'The Midsummer Blockbuster',          text:'Helix swings the largest trade of the offseason — buying starting-lineup firepower and paying in nearly its entire pick vault. ForgeHammer ships QB value for liquidity; the whole exchange repriced within hours.', owner:'Adam' },
];
